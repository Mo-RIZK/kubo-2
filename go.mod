...
replace github.com/ipfs/go-ipld-format v0.6.2 => github.com/Mo-RIZK/go-ipld-format v0.0.0-20250729094912-cffe4aa2cf99

replace github.com/ipfs/boxo v0.32.0 => github.com/Mo-RIZK/boxo-2 v0.0.0-20250911105349-98dac6d1d727
